    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MenuItemInventoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_menuItemInventories", x => x.MenuItemInventoryId);
                    table.ForeignKey(
                        name: "FK_menuItemInventories_inventoryItems_InventoryItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_menuItemInventories_InventoryItemId",
